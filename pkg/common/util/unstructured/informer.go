...
import (
	...
	informer "github.com/kubeflow/tf-operator/pkg/client/informers/externalversions/kubeflow/v1beta1"
	lister "github.com/kubeflow/tf-operator/pkg/client/listers/kubeflow/v1beta1"
)
